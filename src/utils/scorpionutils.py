...
def SetScorpionArgs():
    ...
    parser.add_argument('-l','--logpath', type=Path, metavar='PATH', default='log_images', help="Change default path where the images exif info will be saved. Default is /log_images")
